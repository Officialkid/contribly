  ...
  return (
    <div className="min-h-screen bg-background overflow-hidden">
      <div className="flex flex-col lg:grid lg:grid-cols-2 min-h-screen">
        {/* Right Side - Register Form (order-first on mobile) */}
          ...
          <div className="w-full max-w-md">
            ...
            <div className="bg-card border border-border rounded-card shadow-large p-8 space-y-6">
              <div className="text-center">
                ...
                <p className="text-text-muted mt-2">Join Contribly to manage your contributions</p>
              </div>
          ...
          <div className="relative z-10 flex flex-col justify-center w-full px-8 lg:px-16 py-20">
            <div className="max-w-xl space-y-8 animate-fade-in">
              ...
              <p className="text-xl text-white/80 leading-relaxed">
                Create your organization and start managing contributions, tracking payments, and maintaining detailed records.
              </p>
              ...
              <div className="flex flex-wrap gap-6 pt-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-white font-semibold">Get Started Fast</p>
                    <p className="text-white/60 text-sm">In just a few minutes</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white/60 text-sm">No credit card needed</p>
                  </div>
                </div>
              </div>
            </div>
