              ...
              {!showMfaInput ? (
                ...
                <>
                  ...
                  <div className="text-center">
                    ...
                    <h2 className="text-3xl font-bold text-text-primary">Verify Your Identity</h2>
                    <p className="text-text-muted mt-2">
                      We've sent a 6-digit verification code to<br />
                      <span className="font-semibold text-text-primary">{mfaEmail}</span>
                    </p>
                  </div>
                  ...
                  <form onSubmit={handleMfaSubmit} className="space-y-6">
                    ...
                    <button
                      ...
                      className="w-full py-2 text-text-muted hover:text-primary transition-colors text-sm font-semibold"
                    >
                      ← Back to Login
                    </button>
                  </form>
