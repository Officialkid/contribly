...
export function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  const navigationItems = [
    ...
    },
    {
      ...
      href: `/orgs/${activeOrgId}/payments/unmatched`,
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4v2m0 4v2M7 12a5 5 0 1110 0 5 5 0 01-10 0z" />
        </svg>
      ),
      show: !isChiefAdmin,
    },
    ...
    {
      name: "Withdrawals",
      href: `/orgs/${activeOrgId}/withdrawals`,
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="h-full px-6 flex items-center justify-between lg:justify-end">
          ...
          <div className="flex items-center gap-4">
            ...
            >
              ...
              {notificationsAvailable && unreadCount > 0 && (
